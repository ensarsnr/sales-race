...
function TvComp({ isConfetti }) {
  ...
  return (
    <div className="h-[94.2vh] 2xl:grid 2xl:grid-cols-2 2xl:grid-rows-8 hidden gap-2">
      ...
      <GraphSection />
      <TeamSection />
      <div className="bg-light rounded-3xl shadow row-span-2 col-start-1 row-start-7">
        <div className="h-full w-full flex-col">
          <div className="w-full text-center p-10">
            <span style={{fontFamily:"TitleFont"}} className="text-7xl">Anlık Veri</span>
          </div>
          <div className="p-3">
      ...
      <div className="bg-light h-full rounded-3xl shadow row-span-8 col-start-2 row-start-1 col-span-12">
        <div className="w-full p-5">
          <h1 style={{fontFamily:"TitleFont"}} className="text-7xl text-center font-bold">SIRALAMA</h1>
        </div>
